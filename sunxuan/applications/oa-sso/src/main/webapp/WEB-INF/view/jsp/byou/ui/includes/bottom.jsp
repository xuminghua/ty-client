...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
      ...
      <footer>
        <div id="copyright">
          ...
          <p>Powered by <a href="http://www.jasig.org/cas">BYOU SSO 0.0.0.1</a></p>
        </div>
      </footer>
    ...
    <spring:theme code="cas.javascript.jquery-ui.file" var="casJavascriptJUIFile" text="" />
    <script type="text/javascript" src="<c:url value="${casJavascriptJqueryFile}" />"></script>
    <script type="text/javascript" src="<c:url value="${casJavascriptJUIFile}" />"></script>
