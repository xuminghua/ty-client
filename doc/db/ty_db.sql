...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-06-29 07:54:01
-- 服务器版本： 5.7.14
-- PHP Version: 5.6.25
...
CREATE TABLE `common_carrousel` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '类型： 0：游记 1：商品 2：专题 3：免费资格 4：信息度',
...
CREATE TABLE `common_comment` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '状态 0：待处理 1：处理中 2：处理完成',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) DEFAULT NULL COMMENT '备用'
...
CREATE TABLE `common_rolling` (
  ...
  `type` tinyint(4) DEFAULT NULL COMMENT '类型 0：游记 1：商品 2：免费卷',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) DEFAULT NULL COMMENT '备用'
...
CREATE TABLE `image_info` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '类型： 0：游记 1：商品 2：专题 3：商户 4：免费资格 5：信任度',
  `order_num` tinyint(4) NOT NULL COMMENT '序号',
  `main_page` tinyint(4) NOT NULL COMMENT '是否是主图 0：不是主图 1：是主图',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) DEFAULT NULL COMMENT '备用'
...
CREATE TABLE `merchant_user` (
  ...
  `latest_login_time` datetime NOT NULL COMMENT '最后一次登录时间',
...
CREATE TABLE `product_comment` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '类型： 0：游记 1：商品',
  `comment` varchar(400) DEFAULT NULL COMMENT '评论内容',
  `author_id` bigint(20) NOT NULL COMMENT '发布评论的作者ID',
  `attitude` tinyint(4) NOT NULL COMMENT '0：踩 1：赞',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) NOT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) NOT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) NOT NULL COMMENT '备用'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `product_coupon` (
  `id` bigint(20) NOT NULL COMMENT '主键（自增）',
  `title` varchar(255) NOT NULL COMMENT '标题',
  `type` tinyint(4) NOT NULL COMMENT '免费卷类型',
  ...
  `status` tinyint(4) NOT NULL COMMENT '免费卷状态： 0：有效 1：无效',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) DEFAULT NULL COMMENT '备用'
...
CREATE TABLE `product_info` (
  ...
  `isTop` tinyint(4) NOT NULL COMMENT '是否置顶： 0：否 1：是',
  `isSelf` tinyint(4) NOT NULL COMMENT '是否自营： 0：是 1：否',
  `auditStatus` tinyint(4) NOT NULL COMMENT '审核状态: 0：待审核 1：审核通过 2：审核不通过',
  `ages` varchar(10) DEFAULT NULL COMMENT '1-1或3-10',
  `link` varchar(255) DEFAULT NULL COMMENT '链接',
  `likes` bigint(20) DEFAULT NULL COMMENT '点赞量',
  `address_point` varchar(255) DEFAULT NULL COMMENT '经纬度地址信息',
  `address` varchar(255) DEFAULT NULL COMMENT '地址信息',
  `city` varchar(30) DEFAULT NULL COMMENT '城市',
  `type` tinyint(4) DEFAULT NULL COMMENT '商品类型： 0：用户上传 1：自有',
  `status` tinyint(4) NOT NULL COMMENT '商品状态： 0：正常 1：促销 2：秒杀 3：下架',
  `shelf_time` datetime DEFAULT NULL COMMENT '下架时间',
  `expiry_time` datetime DEFAULT NULL COMMENT '活动结束时间',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) NOT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) NOT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) NOT NULL COMMENT '备用'
...
CREATE TABLE `subject_product` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '产品或游记',
  `order_num` tinyint(4) NOT NULL COMMENT '序号',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
...
CREATE TABLE `travel_info` (
  ...
  `likes` bigint(20) DEFAULT NULL COMMENT '点赞量',
  `type` tinyint(4) NOT NULL COMMENT '游记类型： 0：私人 1：公开',
  `status` tinyint(4) NOT NULL COMMENT '游记状态： 0：草稿 1：待审核 2：审核通过',
  `isTop` tinyint(4) NOT NULL COMMENT '是否置顶： 0：否 1：是',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
...
CREATE TABLE `user_blacklist` (
  `id` bigint(20) NOT NULL COMMENT '主键（自增）',
  `user_id` bigint(20) NOT NULL COMMENT '用户id',
  `reason` tinyint(4) NOT NULL COMMENT '加入黑名单原因 0： 1：',
  `status` tinyint(4) NOT NULL COMMENT '状态： 0：无效 1：有效',
...
CREATE TABLE `user_coupon` (
  ...
  `exchange_deadline` datetime NOT NULL COMMENT '兑换截止时间',
  `use_deadline` datetime NOT NULL COMMENT '使用截止时间',
  `status` tinyint(4) NOT NULL COMMENT '免费卷状态： 0：未使用 1：已使用',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) DEFAULT NULL COMMENT '备用'
...
CREATE TABLE `user_favorite` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '类型： 0：游记 1：商品 2：专题',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) DEFAULT NULL COMMENT '备用'
...
CREATE TABLE `user_friend` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '状态 0：申请中 1：申请通过 2：拒绝',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `tmp_intvalue` int(11) DEFAULT NULL COMMENT '备用',
  `tmp1_charvalue` varchar(255) DEFAULT NULL COMMENT '备用',
  `tmp2_charvalue` varchar(255) DEFAULT NULL COMMENT '备用'
...
CREATE TABLE `user_info` (
  ...
  `baby_birth` tinyint(4) DEFAULT NULL COMMENT '年龄',
...
CREATE TABLE `user_message` (
  ...
  `type` tinyint(4) NOT NULL COMMENT '消息类型： 0：系统消息 1：用户消息等',
  `user_id` bigint(20) DEFAULT NULL COMMENT '接收消息用户ID',
  `status` tinyint(4) NOT NULL COMMENT '消息状态: 0:未发送 1：已发未读 2：已发已读',
